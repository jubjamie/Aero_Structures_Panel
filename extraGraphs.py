...
plt.figure(1)
plt.plot(wingtipdistance, sref, 'k-', label='Shear Force - SRef')
...
plt.figure(2)
plt.plot(wingtipdistance, mref, 'k-', label='Bending Moment - MRef')
...
plt.figure(3)
plt.plot(wingtipdistance, tref, 'k-', label='Torque - TRef')
